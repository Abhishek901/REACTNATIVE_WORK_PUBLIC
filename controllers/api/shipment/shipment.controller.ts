...
class ShipmentController implements IBaseController<ShipmentBussiness> {
  ...
  findAllShipments = async (req: Request, res: Response) => {
    console.log(req.body);
    
    res.status(200).send({ message: "yes you are there..........." });
  };
  ...
  findPerRider = (req: Request, res: Response) => {
    ...
    shipmentBusiness.findByMultiplePopulate(callback, query, [
      "hub_id",
      "user_id",
    ]);
  };
